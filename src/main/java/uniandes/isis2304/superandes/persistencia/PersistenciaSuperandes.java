...
//        	e.printStackTrace();
	...
	/**
	 * M閠odo que elimina, de manera transaccional, una tupla en la tabla PRODUCTO_ESTANTE, dados los identificadores de bebedor y bebida
...
//        	e.printStackTrace();
	...
	/**
	 * M閠odo que elimina, de manera transaccional, una tupla en la tabla PRODUCTO_BODEGA, dados los identificadores de bebedor y bebida
	 * @param idBodega - El identificador del bodega
	 * @param idProducto - El identificador de la producto
	 * @return El n鷐ero de tuplas eliminadas. -1 si ocurre alguna Excepci髇
	 */
...
//        	e.printStackTrace();
	...
	/* ****************************************************************
	 * 			M閠odos para manejar los ProductoTransaccion
	 *****************************************************************/
	...
	public ProductoTransaccion adicionarProductoTransaccion(long id, int cantidad)
	{
        ...
        try
        {
            ...
            log.trace ("Inserci髇 de ProductoTransaccion: " + id + ": " + tuplasInsertadas + " tuplas insertadas");
...
//        	e.printStackTrace();
	...
	/* ****************************************************************
	 * 			M閠odos para manejar PromocionSucursal
	 *****************************************************************/
	...
	public PromocionSucursal adicionarPromocionSucursal(long promocion, long sucursal)
	{
        ...
        try
        {
            ...
            log.trace ("Inserci髇 de PromocionSucursal: " + promocion + ": " + tuplasInsertadas + " tuplas insertadas");
