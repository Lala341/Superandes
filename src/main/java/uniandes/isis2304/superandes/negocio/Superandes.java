...
public class Superandes {
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	...
	/**
	 * Encuentra un Sucursal y su informaci�n b�sica, seg�n su identificador
	 * @param idSucursal - El identificador del Sucursal buscado
	 * @return Un objeto Sucursal que corresponde con el identificador buscado y lleno con su informaci�n b�sica
	 * 			null, si un Sucursal con dicho identificador no existe
	 */
	public Sucursal darSucursalPorId (long idSucursal)
	{
        log.info ("Dar informaci�n de un Sucursal por id: " + idSucursal);
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos Sucursal con todos las Sucursales que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOSucursal con todos las Sucursales que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	/* ****************************************************************
	 * 			M�todos para manejar los Bodegas
	 *****************************************************************/
	...
	/**
	 * Encuentra un Bodega y su informaci�n b�sica, seg�n su identificador
	 * @param idBodega - El identificador del Bodega buscado
	 * @return Un objeto Bodega que corresponde con el identificador buscado y lleno con su informaci�n b�sica
	 * 			null, si un Bodega con dicho identificador no existe
	 */
	public Bodega darBodegaPorId (long idBodega)
	{
        log.info ("Dar informaci�n de un Bodega por id: " + idBodega);
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos Bodega con todos las Bodegas que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOBodega con todos las Bodegas que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	/**
	 * Encuentra un Estante y su informaci�n b�sica, seg�n su identificador
	 * @param idEstante - El identificador del Estante buscado
	 * @return Un objeto Estante que corresponde con el identificador buscado y lleno con su informaci�n b�sica
	 * 			null, si un Estante con dicho identificador no existe
	 */
	public Estante darEstantePorId (long idEstante)
	{
        log.info ("Dar informaci�n de un Estante por id: " + idEstante);
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos Estante con todos las Estantes que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOEstante con todos las Estantes que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
...
<<<<<<< HEAD
	 ...
	 * @return El objeto Categoria adicionado. null si ocurre alguna Excepci�n
=======
...
>>>>>>> branch 'master' of https://github.com/Lala341/Superandes.git
	...
	/**
	 * Encuentra la informaci�n b�sica de los Categorias, seg�n su nombre
	 * @param nombre - El nombre de Categoria a buscar
	 * @return Una lista de Categorias con su informaci�n b�sica, donde todos tienen el nombre buscado.
	 * 	La lista vac�a indica que no existen Categorias con ese nombre
	 */
	public List<Categoria> darCategoriasPorNombre (String nombre)
	{
        log.info ("Dar informaci�n de Categorias por nombre: " + nombre);
        List<Categoria> Categorias = pp.darCategoriasPorNombre (nombre);
        log.info ("Dar informaci�n de Categorias por nombre: " + Categorias.size() + " Categorias con ese nombre existentes");
        return Categorias;
 	}
	...
	{
        log.info ("Dar informaci�n de Categorias por id: " + id);
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos Categoria con todos las Categorias que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOCategoria con todos las Categorias que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * @return El objeto Perecedero adicionado. null si ocurre alguna Excepci�n
	 */
	...
	/**
	 * Encuentra un Perecedero y su informaci�n b�sica, seg�n su identificador
	 * @param idPerecedero - El identificador del Perecedero buscado
	 * @return Un objeto Perecedero que corresponde con el identificador buscado y lleno con su informaci�n b�sica
	 * 			null, si un Perecedero con dicho identificador no existe
	 */
	public Perecedero darPerecederoPorId (long idPerecedero)
	{
        log.info ("Dar informaci�n de un Perecedero por id: " + idPerecedero);
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos Perecedero con todos las Perecederos que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOPerecedero con todos las Perecederos que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * @return El objeto NoPerecedero adicionado. null si ocurre alguna Excepci�n
	 */
	...
	/**
	 * Encuentra un NoPerecedero y su informaci�n b�sica, seg�n su identificador
	 * @param idNoPerecedero - El identificador del NoPerecedero buscado
	 * @return Un objeto NoPerecedero que corresponde con el identificador buscado y lleno con su informaci�n b�sica
	 * 			null, si un NoPerecedero con dicho identificador no existe
	 */
	public NoPerecedero darNoPerecederoPorId (long idNoPerecedero)
	{
        log.info ("Dar informaci�n de un NoPerecedero por id: " + idNoPerecedero);
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos NoPerecedero con todos las NoPerecederos que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VONoPerecedero con todos las NoPerecederos que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	/**
	 * Encuentra la informaci�n b�sica de los Productos, seg�n su nombre
	 * @param nombre - El nombre de Producto a buscar
	 * @return Una lista de Productos con su informaci�n b�sica, donde todos tienen el nombre buscado.
	 * 	La lista vac�a indica que no existen Productos con ese nombre
	 */
	public List<Producto> darProductosPorNombre (String nombre)
	{
        log.info ("Dar informaci�n de Productos por nombre: " + nombre);
        List<Producto> Productos = pp.darProductosPorNombre (nombre);
        log.info ("Dar informaci�n de Productos por nombre: " + Productos.size() + " Productos con ese nombre existentes");
        return Productos;
 	}

	/**
	 * Encuentra la informaci�n b�sica de los Productos, seg�n su nombre y los devuelve como VO
	 * @param nombre - El nombre de Producto a buscar
	 * @return Una lista de Productos con su informaci�n b�sica, donde todos tienen el nombre buscado.
	 * 	La lista vac�a indica que no existen Productos con ese nombre
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos Producto con todos las Productos que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOProducto con todos las Productos que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	/* ****************************************************************
	 * 			M�todos para manejar la relaci�n ProductoEstante
	 *****************************************************************/
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos ProductoEstante con todos los ProductoEstante que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	/* ****************************************************************
	 * 			M�todos para manejar la relaci�n ProductoBodega
	 *****************************************************************/
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos ProductoBodega con todos los ProductoBodega que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	/* ****************************************************************
	 * 			M�todos para manejar los PersonasNaturales
	 *****************************************************************/
	 ...
	 * @return El objeto PersonaNatural adicionado. null si ocurre alguna Excepci�n
	 */
	...
	/**
	 * Encuentra un PersonaNatural y su informaci�n b�sica, seg�n su identificador
	 * @param idPersonaNatural - El identificador del PersonaNatural buscado
	 * @return Un objeto PersonaNatural que corresponde con el identificador buscado y lleno con su informaci�n b�sica
	...
	{
        log.info ("Dar informaci�n de un PersonaNatural por id: " + idPersonaNatural);
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos PersonaNatural con todos las PersonasNaturales que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOPersonaNatural con todos las PersonasNaturales que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	/* ****************************************************************
	 * 			M�todos para manejar los EMPRESAS
	 *****************************************************************/
	...
	/**
	 * Encuentra un empresa y su informaci�n b�sica, seg�n su identificador
	 * @param idEmpresa - El identificador del empresa buscado
	 * @return Un objeto Empresa que corresponde con el identificador buscado y lleno con su informaci�n b�sica
	 * 			null, si un empresa con dicho identificador no existe
	 */
	public Empresa darEmpresaPorId (long idEmpresa)
	{
        log.info ("Dar informaci�n de un empresa por id: " + idEmpresa);
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	...
	/* ****************************************************************
	 * 			M�todos para manejar Fidelizacion
	 *****************************************************************/
	/**
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de Fidelizacion, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOFidelizacion con todos los tipos de Fidelizacion que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
...
<<<<<<< HEAD
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de Venta, llenos con su informaci�n b�sica
=======
	 *	Lista  VentaTest en Superandes
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de VentaTest, llenos con su informaci�n b�sica
>>>>>>> branch 'master' of https://github.com/Lala341/Superandes.git
	 */
...
<<<<<<< HEAD
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOVenta con todos los tipos de Venta que conoce la aplicaci�n, llenos con su informaci�n b�sica
=======
	 * Encuentra VentaTest en Superandes y los devuelve como una lista de VOVenta
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOVenta con todos los tipos de VentaTest que conoce la aplicaci�n, llenos con su informaci�n b�sica
>>>>>>> branch 'master' of https://github.com/Lala341/Superandes.git
	 */
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de Factura, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOFactura con todos los tipos de Factura que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de CarritoCompras, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOCarritoCompras con todos los tipos de CarritoCompras que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * @return Un objeto CarritoCompras, con su informaci�n b�sica
	 */
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de ProductoVenta, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOProductoVenta con todos los tipos de ProductoVenta que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de ProductoCarritoCompras, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOProductoCarritoCompras con todos los tipos de ProductoCarritoCompras que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de Promocion, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOPromocion con todos los tipos de Promocion que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * @return Un objeto Promocion, con su informaci�n b�sica
	 */
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	...
	/**
	 * Encuentra un promocionUnidad y su informaci�n b�sica, seg�n su identificador
	 * @param idPromocionUnidad - El identificador del promocionUnidad buscado
	 * @return Un objeto PromocionUnidad que corresponde con el identificador buscado y lleno con su informaci�n b�sica
	...
	{
        log.info ("Dar informaci�n de un promocionUnidad por id: " + idPromocionUnidad);
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos PromocionUnidad con todos las promocionesUnidad que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOPromocionUnidad con todos las promocionesUnidad que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	/**
	 * Encuentra un promocionDescuento y su informaci�n b�sica, seg�n su identificador
	 * @param idPromocionDescuento - El identificador del promocionDescuento buscado
	 * @return Un objeto PromocionDescuento que corresponde con el identificador buscado y lleno con su informaci�n b�sica
	...
	{
        log.info ("Dar informaci�n de un promocionDescuento por id: " + idPromocionDescuento);
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos PromocionDescuento con todos las promocionDescuento que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOPromocionDescuento con todos las promocionDescuento que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	/**
	 * Encuentra un promocionParteDescuento y su informaci�n b�sica, seg�n su identificador
	 * @param idPromocionParteDescuento - El identificador del promocionParteDescuento buscado
	 * @return Un objeto PromocionParteDescuento que corresponde con el identificador buscado y lleno con su informaci�n b�sica
	...
	{
        log.info ("Dar informaci�n de un promocionParteDescuento por id: " + idPromocionParteDescuento);
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos PromocionParteDescuento con todos las promocionesParteDescuento que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOPromocionParteDescuento con todos las promocionesParteDescuento que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	/* ****************************************************************
	 * 			M�todos para manejar los PROMOCION_CANTIDADES
	 *****************************************************************/
	...
	/**
	 * Encuentra un promocionCantidad y su informaci�n b�sica, seg�n su identificador
	 * @param idPromocionCantidad - El identificador del promocionCantidad buscado
	 * @return Un objeto PromocionCantidad que corresponde con el identificador buscado y lleno con su informaci�n b�sica
	...
	{
        log.info ("Dar informaci�n de un promocionCantidad por id: " + idPromocionCantidad);
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos PromocionCantidad con todos las promocionesCantidad que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOPromocionCantidad con todos las promocionesCantidad que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de PromocionProducto, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOPromocionProducto con todos los tipos de PromocionProducto que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * @return Un objeto PromocionProducto, con su informaci�n b�sica
	 */
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de Proveedores, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOProveedores con todos los tipos de Proveedores que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * @return Un objeto Proveedores, con su informaci�n b�sica
	 */
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de ProductoOfrecido, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOProductoOfrecido con todos los tipos de ProductoOfrecido que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de OrdenPedido, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOOrdenPedido con todos los tipos de OrdenPedido que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	 ...
	 * @return Un objeto OrdenPedido, con su informaci�n b�sica
	 */
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de Administrador, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOAdministrador con todos los tipos de Administrador que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
	...
	* @return El objeto. null si ocurre alguna Excepci�n
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de AdministradorSucursal, llenos con su informaci�n b�sica
	 */
	 ...
	 * Adiciona entradas al log de la aplicaci�n
	 * @return Una lista de objetos VOAdministradorSucursal con todos los tipos de AdministradorSucursal que conoce la aplicaci�n, llenos con su informaci�n b�sica
	 */
