...
//			e.printStackTrace();
    	...
    	try
		{
			// Lectura PersonaNatural con la tabla vacía
		...
		{
//			e.printStackTrace();
			String msg = "Error en la ejecución de las pruebas de operaciones sobre la tabla PersonaNatural.\n";
			msg += "Revise el log de superandes y el de datanucleus para conocer el detalle de la excepción";
			System.out.println (msg);
	...
	public void unicidadPersonaNaturalTest() 
	{
		...
		{
//			e.printStackTrace();
			log.info ("Prueba de UNICIDAD de PersonaNatural incompleta. No se pudo conectar a la base de datos !!. La excepción generada es: " + e.getClass ().getName ());
			log.info ("La causa es: " + e.getCause ().toString ());
		...
		{
//			e.printStackTrace();
			String msg = "Error en la ejecución de las pruebas de UNICIDAD sobre la tabla PersonaNatural.\n";
			msg += "Revise el log de superandes y el de datanucleus para conocer el detalle de la excepción";
			System.out.println (msg);
